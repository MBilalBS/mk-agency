...
export const projectsData = [
  ...
  { title: "Reccos", category: "Real Estate", shortDesc: "L'immobilier de Dubaï, fractionné et accessible.", longDesc: "RECCOS révolutionne l'accès à l'immobilier de prestige en permettant à quiconque d'investir dans le marché florissant de Dubaï à partir de seulement 2 000 AED. Grâce à un système de fractionnement réel et certifié, chaque investisseur devient copropriétaire d'un bien officiellement enregistré aux Émirats, avec un titre de propriété et un certificat légalement vérifiable à la clé. Contrairement aux produits financiers classiques, RECCOS ne vend pas une promesse numérique mais une part tangible d'un actif physique, offrant une transparence totale sur la traçabilité de chaque investissement. Son Marketplace ouvert et liquide permet en outre de revendre ses parts librement selon ses objectifs, sans attendre la vente globale de la propriété, et de profiter de l'appréciation du marché en temps réel pour maximiser ses rendements." },
  ...
  { title: "Nursehub", category: "Medical", shortDesc: "La plateforme des professionnels de santé.", longDesc: "Nursehub redéfinit la mise en relation entre infirmiers indépendants et établissements de santé en proposant une plateforme digitale complète pensée pour les professionnels du secteur médical. Face à une demande croissante de flexibilité et de mobilité dans les métiers du soin, Nursehub offre aux infirmiers la possibilité de gérer leur planning, de trouver des missions adaptées à leur profil et de suivre leurs revenus depuis une interface intuitive et centralisée. Du côté des établissements, cliniques, hôpitaux et EHPAD peuvent accéder en quelques clics à un vivier de professionnels qualifiés et disponibles, réduisant considérablement les délais de recrutement et les coûts associés aux agences traditionnelles. En digitalisant l'ensemble du parcours de mise en relation, de la recherche de mission jusqu'à la signature du contrat, Nursehub s'impose comme le partenaire incontournable d'un secteur en pleine mutation, où la réactivité et la fiabilité sont des enjeux cruciaux pour la qualité des soins." },
  { title: "Quantix", category: "Finance", shortDesc: "La gestion de patrimoine réinventée.", longDesc: "Quantix s'impose comme une solution de référence dans la gestion et l'optimisation de patrimoine immobilier, en offrant aux propriétaires, investisseurs et gestionnaires d'actifs une plateforme analytique complète et intelligente. En agrégeant l'ensemble des données liées à un portefeuille immobilier — valorisation en temps réel, rendements locatifs, charges, fiscalité et perspectives de marché — Quantix transforme des informations complexes en indicateurs clairs et actionnables pour une prise de décision éclairée. Sa technologie repose sur des algorithmes avancés capables d'identifier les opportunités d'optimisation, de simuler différents scénarios d'investissement et d'anticiper les évolutions du marché pour maximiser la performance de chaque actif. Que vous soyez un particulier souhaitant piloter votre patrimoine avec précision ou un professionnel gérant plusieurs dizaines de biens, Quantix adapte son niveau d'analyse à vos besoins et vous accompagne dans chaque étape de votre stratégie patrimoniale avec rigueur et transparence." },
